...
$Url32 = 'https://github.com/doublecmd/doublecmd/releases/download/v1.0.0/doublecmd-1.0.0.i386-win32.zip'
$Url64 = 'https://github.com/doublecmd/doublecmd/releases/download/v1.0.0/doublecmd-1.0.0.x86_64-win64.zip'
