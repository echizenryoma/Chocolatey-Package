...
$Url32 = 'https://github.com/doublecmd/doublecmd/releases/download/v1.0.1/doublecmd-1.0.1.i386-win32.zip'
$Url64 = 'https://github.com/doublecmd/doublecmd/releases/download/v1.0.1/doublecmd-1.0.1.x86_64-win64.zip'
