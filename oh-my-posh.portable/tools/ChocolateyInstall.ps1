...
$Url32 = 'https://github.com/JanDeDobbeleer/oh-my-posh/releases/download/v12.18.3/posh-windows-386.exe'
$Url64 = 'https://github.com/JanDeDobbeleer/oh-my-posh/releases/download/v12.18.3/posh-windows-amd64.exe'
$UrlExtra = 'https://github.com/JanDeDobbeleer/oh-my-posh/releases/download/v12.18.3/themes.zip'
