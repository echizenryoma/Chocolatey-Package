...
$Url32 = 'https://github.com/JanDeDobbeleer/oh-my-posh/releases/download/v13.1.1/posh-windows-386.exe'
$Url64 = 'https://github.com/JanDeDobbeleer/oh-my-posh/releases/download/v13.1.1/posh-windows-amd64.exe'
$UrlExtra = 'https://github.com/JanDeDobbeleer/oh-my-posh/releases/download/v13.1.1/themes.zip'
