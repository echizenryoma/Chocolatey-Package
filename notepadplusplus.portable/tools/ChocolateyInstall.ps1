...
$Url32 = 'http://download.notepad-plus-plus.org/repository/7.x/7.8.6/npp.7.8.6.bin.7z'
$Checksum32 = ''
$ChecksumType32 = 'sha256'
$Url64 = 'http://download.notepad-plus-plus.org/repository/7.x/7.8.6/npp.7.8.6.bin.x64.7z'
$Checksum64 = ''
