...
function global:au_GetLatest {
    ...
    $url32 = "https://nodejs.org/dist/v${version}/node-v${version}-win-x86.7z"
    $url64 = "https://nodejs.org/dist/v${version}/node-v${version}-win-x64.7z"

    $page = Invoke-WebRequest -UseBasicParsing -Uri "https://nodejs.org/dist/v${version}/SHASUMS256.txt"
