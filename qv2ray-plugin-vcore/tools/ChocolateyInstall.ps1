...
$PackageName = 'qv2ray'
$Url32 = 'https://github.com/v2fly/v2ray-core/releases/download/v4.32.1/v2ray-windows-32.zip'
$Url64 = 'https://github.com/v2fly/v2ray-core/releases/download/v4.32.1/v2ray-windows-64.zip'
