...
$PackageName = 'tomcat'
$Url32 = 'https://mirrors.ustc.edu.cn/apache/tomcat/tomcat-9/v9.0.19/bin/apache-tomcat-9.0.19-windows-x86.zip'
$Url64 = 'https://mirrors.ustc.edu.cn/apache/tomcat/tomcat-9/v9.0.19/bin/apache-tomcat-9.0.19-windows-x64.zip'
